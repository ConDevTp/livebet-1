...
TxtRotate.prototype.tick = function () {
  ...
  this.el.innerHTML = '<span class="wrap" style="color: #830AE8 !important" >' + this.txt + '</span>';
...
window.onload = function () {
  ...
  css.type = "text/css";
  css.innerHTML = ".txt-rotate > .wrap { border-left: 0.08em solid #830AE8 !important }";
...
function selectgame(obj) {
  var selectteditem = document.getElementsByClassName("selectedgame")[0];

  selectteditem.classList.remove("selectedgame");
  obj.classList.add("selectedgame");
}
// For Blogs

function SelectedBlog(obj) {
  var selectteditem = document.getElementsByClassName("blogselectted")[0];

  selectteditem.classList.remove("blogselectted");
  obj.classList.add("blogselectted");
}
